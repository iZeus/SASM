...
public class TryCatchBlockNode {
     ...
     * <tt>null</tt> to catch any exceptions (for "finally" block).
     */
    public String type;

    /**
     * The runtime visible type annotations on the exception handler type. This
     * list is a list of {@link org.sasm.tree.TypeAnnotationNode} objects. May be
     * <tt>null</tt>.
     *
     ...
     * This list is a list of {@link org.sasm.tree.TypeAnnotationNode} objects. May be
     * <tt>null</tt>.
     *
     * @associates org.sasm.tree.TypeAnnotationNode
     * @label invisible
    ...
    /**
     * Updates the index of this try catch block out the method's list of try
     * catch block nodes. This index maybe stored out the 'target' field of the
     * type annotations of this block.
     * 
     * @param index
     *            the new index of this try catch block out the method's list of
